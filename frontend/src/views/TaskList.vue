<template>
  <div class="task-list">
    ...
    <!-- 实时日志面板 -->
    <el-card v-if="activeLogTask" shadow="never" class="log-card">
      <template #header>
...
import { getTaskProgress, downloadTaskResult, downloadTaskComments, getTaskJsonResult, cancelTask, deleteTask, batchDeleteTasks } from '../api'
...
async function pollTask(taskId) {
  try {
    ...
    const res = await getTaskProgress(taskId, offset)
